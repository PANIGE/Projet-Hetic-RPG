...
class handler:
    ...
    def Script(self):
        ...
        self.ShowMessage("Narrateur","Ooooook attender")
        ...
        glob.AudioManager.PlaySound("clic_souri.mp3")
        self.wait(1000)
        self.ShowMessage("Narrateur","c'est bon on recomence")
        self.ShowMessage("Chare Melmou","Je suis Chara Melmou ")
        self.ShowMessage("Narrateur","C'est bon on peut commencer")
        self.ShowMessage("Narrateur","vous etes Chara Melmou. Vous etes dans une auberge, apret avoir bien manger vous decider d'aller acheter de la réglisse")
        self.ShowMessage("Chara Melmou","rééééééégliiiiiiise")
        self.ShowMessage("Narrateur","Tais toi j'introdui le scénario!!!!!!!!!!!")
